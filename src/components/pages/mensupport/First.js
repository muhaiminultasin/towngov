          ...
          <div className="row row-gutter-30">
              ...
              <div className="support-card">
                ...
                <div className="support-card-meta">
                  <div className="support-card-text">
                    <Link to="/support-details">Tourist</Link>
                  </div>
                  <div className="support-card-title">
                    <Link to="/support-details">Carnegie Hall</Link>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="col-lg-4 col-md-4">
              <div className="support-card">
                ...
                <div className="support-card-meta">
                  <div className="support-card-text">
                    <Link to="/support-details">Travel</Link>
                  </div>
                  <div className="support-card-title">
                    <Link to="/support-details">Penn Station</Link>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="col-lg-4 col-md-4">
              <div className="support-card">
                ...
                <div className="support-card-meta">
                  ...
                  <div className="support-card-title">
                    <Link to="/support-details">Black Fox Coffee Shop</Link>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="col-lg-4 col-md-4">
              <div className="support-card">
                ...
                <div className="support-card-meta">
                  ...
                  <div className="support-card-title">
                    <Link to="/support-details">Central Park Tower</Link>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="col-lg-4 col-md-4">
              <div className="support-card">
                ...
                <div className="support-card-meta">
                  ...
                  <div className="support-card-title">
                    <Link to="/support-details">Metropolitan Museum</Link>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="col-lg-4 col-md-4">
              <div className="support-card">
                ...
                <div className="support-card-meta">
                  <div className="support-card-text">
                    <Link to="/support-details">Business</Link>
                  </div>
                  <div className="support-card-title">
                    <Link to="/support-details">Empire State Building</Link>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="col-lg-4 col-md-4">
              <div className="support-card">
                ...
                <div className="support-card-meta">
                  <div className="support-card-text">
                    <Link to="/support-details">Places</Link>
                  </div>
                  <div className="support-card-title">
                    <Link to="/support-details">Broadway Road</Link>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="col-lg-4 col-md-4">
              <div className="support-card">
                ...
                <div className="support-card-meta">
                  <div className="support-card-text">
                    <Link to="/support-details">Intercity</Link>
                  </div>
                  <div className="support-card-title">
                    <Link to="/support-details">Grand Central Terminal</Link>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="col-lg-4 col-md-4">
              <div className="support-card">
                ...
                <div className="support-card-meta">
                  ...
                  <div className="support-card-title">
                    <Link to="/support-details">Fulton Center</Link>
                  </div>
                </div>
              </div>
            </div>
