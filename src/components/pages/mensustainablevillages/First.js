            ...
            <div className="col-lg-8">
              ...
              <div className="service-details-content-box">
                ...
                <p>
                  ...
                  iste natus error sit voluptatem accusantium totam rem aperiam,
                  eaque ipsa quae.
                </p>
              </div>
              ...
              <ul className="list-unstyled list-style-two">
                <li>
                  ...
                  <h5>
                    Every pleasure is to be welcomed &amp; every pain get
                    avoided.
                  </h5>
                </li>
                ...
                <li>
                  <i className="fa-solid fa-circle-arrow-right" />
                  <h5>
                    Quisque tincidunt eros ac place viverra simply free text.
                  </h5>
                </li>
              </ul>
