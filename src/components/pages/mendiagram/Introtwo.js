...
function Introtwo() {
  ...
  return (
    <>
            ...
            <div className="container">
                ...
                <div className="col-lg-12 col-xl-6 col-xxl-6">
                    ...
                    <div className="about-two-image-inner img-one">
                        <img src={Gallery05} alt="img-30" />
                        <img src={Shapes03} className="floated-image" alt="img-31" />
                        <div className="sign-text">Kevin Martin</div>
                    </div>
                    
                    <div className="about-two-image-inner img-two">
                        <img src={Shapes01} alt="img-32" className="mayor-image" />
                        <img src={Gallery06} alt="img-33" />
                    </div>
        ...
        {video && 
            <Iframe  className="ytp-cued-thumbnail-overlay" data-layer="4">
                <div className="ytp-cued-thumbnail-overlay-image" style={{backgroundImage: `url(&quot;https://i.ytimg.com/vi/rzfmZC3kg3M/maxresdefault.jpg?sqp=-oaymwEmCIAKENAF8quKqQMa8AEB-AHUBoAC4AOKAgwIABABGHIgWSgvMA8=&amp;rs=AOn4CLAH33qWSRN6OrdXatPoFW9U0SPl8A&quot;)`}}> </div>
