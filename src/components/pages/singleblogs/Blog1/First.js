...
import Blogdeatils01 from "../../../../assets/image/Future.jpeg";
          ...
          <div className="row">
            <div className="col-lg-8">
              ...
              <div className="news-details-content-box">
                ...
                <p>
                  Modular engineering is quickly transforming the way we build
                  homes. Instead of months of on-site construction, modular
                  homes are built in sections at a factory and assembled
                  on-site—faster, cleaner, and often cheaper. This method
                  reduces material waste, lowers labor costs, and ensures
                  consistent quality. It’s also more eco-friendly, with many
                  designs incorporating energy-efficient materials from the
                  start. As cities face rising housing demands, modular
                  construction offers a smart, scalable solution. From sleek
                  urban apartments to off-grid cabins, the future of housing is
